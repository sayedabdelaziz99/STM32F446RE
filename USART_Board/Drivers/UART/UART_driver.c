...
void USART_ClearFlag(USART_type *pUSARTx, uint16_t StatusFlagName)
{
...
void USART_IRQPriorityConfig(uint8_t IRQNumber,uint32_t IRQPriority)
{
	...
	uint8_t shift_amount = ( 8 * iprx_section) + ( 8 - NO_PI_BITS_IMPLEMENTED) ;

	*(  IPR_BASEADDR ) |=  ( IRQPriority << shift_amount );
